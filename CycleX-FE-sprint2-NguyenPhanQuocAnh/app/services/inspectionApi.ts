...
/**
 * S-24: Get review detail for a listing
 * GET /api/inspector/{inspectorId}/reviews/{listingId}
 * @param inspectorId - The inspector's ID
 * @param listingId - The listing's ID
 * @returns Review detail object (inspection decision, listing info, review metadata)
 */
export const getReviewDetail = async (
  ...
  return axiosInstance.get(
    `/api/inspector/${inspectorId}/reviews/${listingId}`
  );
};

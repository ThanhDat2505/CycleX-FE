...
export default function DisputeResultPage() {
  ...
  useEffect(() => {
    async function fetchDispute() {
      if (isNaN(disputeId)) {
        setError("M├ú khiß║┐u nß║íi kh├┤ng hß╗úp lß╗ç.");
        setIsLoading(false);
        return;
      }
      ...
      try {
        ...
        setError(err.message || "Kh├┤ng t├¼m thß║Ñy th├┤ng tin khiß║┐u nß║íi.");
      } finally {
        setIsLoading(false);
      }
    }
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
        ...
        <p className="mt-4 text-gray-500 font-bold animate-pulse uppercase tracking-wider text-xs">
          ─Éang tß║úi kß║┐t quß║ú khiß║┐u nß║íi...
        </p>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center animate-scale-in border border-gray-100">
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            {error ||
              "Khiß║┐u nß║íi n├áy kh├┤ng tß╗ôn tß║íi hoß║╖c bß║ín kh├┤ng c├│ quyß╗ün truy cß║¡p."}
          </p>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-8 border border-gray-100">
          ...
          >
            ...
            >
              {isSolved
                ? "Khiß║┐u nß║íi ─æ╞░ß╗úc chß║Ñp nhß║¡n"
                : isRejected
                  ? "Khiß║┐u nß║íi bß╗ï tß╗½ chß╗æi"
                  : "─Éang chß╗¥ giß║úi quyß║┐t"}
            </h1>
            <p
            ...
            >
              M├ú khiß║┐u nß║íi: #{dispute.disputeId}
            </p>
          </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                {dispute.resolvedAt && (
                  <p className="mt-4 text-[10px] text-gray-400 font-bold uppercase tracking-tighter">
                    Giß║úi quyß║┐t l├║c: {formatDate(dispute.resolvedAt)}
                  </p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-gray-400 text-xs font-bold uppercase tracking-tighter">
                  Gß╗¡i l├║c: {formatDate(dispute.createdAt)}
                </span>
              </div>
            </div>
        ...
        <div className="mt-12 text-center space-y-6">
          <p className="text-gray-400 text-[11px] font-bold uppercase tracking-[0.2em] max-w-sm mx-auto leading-loose">
            CycleX ─æß║úm bß║úo t├¡nh minh bß║ích v├á c├┤ng bß║▒ng cho mß╗ìi giao dß╗ïch. Quyß║┐t
            ─æß╗ïnh cß╗ºa Ban quß║ún trß╗ï l├á quyß║┐t ─æß╗ïnh cuß╗æi c├╣ng.
          </p>

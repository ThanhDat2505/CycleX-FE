        ...
        <div className={STYLES.card}>
            ...
            <div className={STYLES.content}>
                ...
                <p className={STYLES.terms}>
                    {MESSAGES.S50_REVIEW_TERMS} <a href="/guide" className={STYLES.termsLink}>{MESSAGES.S50_REVIEW_TOS}</a> & <a href="/guide" className={STYLES.termsLink}>{MESSAGES.S50_REVIEW_PRIVACY}</a>.
                    <br />

...
const STYLES = {
  ...
  forgotLink:
    "text-sm text-brand-primary hover:text-brand-primary/80 transition-colors font-semibold",
  registerRow:
    "text-center mt-6 text-sm text-gray-500 animate-fade-in delay-300",

...
const STYLES = {
    ...
    title: 'text-gray-800 font-bold leading-snug group-hover:text-brand-primary transition-colors mb-4',
    bottomRow: 'mt-auto flex items-end justify-between gap-3 pt-4 border-t border-gray-100',
    priceLabel: 'text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-0.5 whitespace-nowrap',
    priceValue: 'text-lg font-black text-brand-primary tracking-tight whitespace-normal break-all',

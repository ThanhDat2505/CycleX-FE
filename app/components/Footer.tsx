/**
 * Footer Component
 * Site-wide footer with logo, links, and social media
        ...
        <footer className="bg-brand-bg text-white">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="md:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold">CycleX</span>
                        </div>
                        <p className="text-gray-400 text-sm mb-4">
                            Nền tảng mua bán xe đạp uy tín với hệ thống kiểm định chuyên nghiệp
                        </p>
                        {/* Social Media */}
                        <div className="flex gap-3">
                            <a href="#" className="w-9 h-9 bg-gray-700 hover:bg-brand-primary rounded-full flex items-center justify-center transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <button onClick={handleHomeClick} className="text-gray-400 hover:text-brand-primary transition-colors">
                                    Trang Chủ
                                </button>
                            </li>
                            <li>
                ...
                <div className="border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
                    <p>&copy; {new Date().getFullYear()} CycleX. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );

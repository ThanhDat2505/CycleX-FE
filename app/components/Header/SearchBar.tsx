...
const STYLES = {
    toggleButton: 'text-white hover:text-brand-primary transition-colors',
    icon: 'w-6 h-6',
    form: 'flex flex-col gap-1',
    inputWrapper: 'relative flex items-center gap-2',
    input: 'w-48 md:w-64 px-4 py-2 rounded-lg text-gray-800 focus:outline-none focus:ring-2',
    inputError: 'ring-2 ring-red-500 focus:ring-red-500',
    inputNormal: 'focus:ring-brand-primary',
    loadingWrapper: 'absolute right-3 top-1/2 -translate-y-1/2',
    spinner: 'animate-spin h-5 w-5 text-brand-primary',
    spinnerCircle: 'opacity-25',
    spinnerPath: 'opacity-75',
    errorText: 'text-red-400 text-sm px-1 absolute -bottom-6 left-0 whitespace-nowrap',
} as const;

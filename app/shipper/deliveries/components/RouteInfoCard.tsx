  ...
  return (
    <div className="p-6 relative z-10">
      <div className="flex gap-4">
        <div className="mt-1">
          <div
            className={`w-4 h-4 rounded-full ${dotColor} border-4 ${borderColor} shadow-sm`}
          />
        </div>
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 mt-3">
            <a
              ...
              className="flex items-center gap-1.5 text-sm font-medium text-blue-600 hover:text-blue-700 bg-blue-50 px-3 py-1.5 rounded-full transition-colors"
            >

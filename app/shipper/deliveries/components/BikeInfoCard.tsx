                ...
                <div className="flex-1 min-w-0 py-1">
                    ...
                    <div className="mt-2 space-y-1">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>{MESSAGES.S62_COD_LABEL} <span className="font-semibold text-gray-900">{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(delivery.codAmount || 0)}</span></span>
                        </div>
                        {delivery.note && (

          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              >
                ...
                <option value="UPDATE_USER" className="bg-brand-bg">
                  Cập nhật người dùng
                </option>
                <option value="UPDATE_ROLE" className="bg-brand-bg">
                  Thay đổi vai trò
                </option>
                <option value="UPDATE_STATUS" className="bg-brand-bg">
                  Thay đổi trạng thái
                </option>
                <option
                  value="OVERRIDE_DISPUTE"
                  className="bg-brand-bg text-rose-400"
                >
                  Ghi đè khiếu nại
                </option>
                <option
                  value="REFUND_ISSUE"
                  className="bg-brand-bg text-emerald-400"
                >
                  Hoàn tiền
                </option>
                <option value="DELETE_POST" className="bg-brand-bg">
                  Xóa bài đăng
                </option>
              </select>
              <Filter
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="flex flex-col">
                          <span className="text-[11px] font-black text-white group-hover:text-brand-primary transition-colors">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-bold text-gray-300 font-mono tracking-tighter bg-white/5 px-3 py-1 rounded-lg border border-white/5 group-hover:border-white/10 transition-colors">
                            {log.targetId}
                          </span>
                        </div>
                      </td>
          ...
          {!loading && totalPages > 1 && (
            <div className="px-8 py-6 border-t border-white/5 flex items-center justify-between bg-white/[0.01]">
              <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">
                ...
                / <span className="text-white">{total}</span> Nhật ký
              </p>

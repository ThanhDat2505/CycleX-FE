          ...
          <div className="lg:col-span-4 grid grid-cols-2 gap-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="ACTIVE" className="bg-brand-bg text-emerald-400">
                  ACTIVE
                </option>
                <option value="SUSPENDED" className="bg-brand-bg text-rose-400">
                  SUSPENDED
                </option>
              </select>
              <Filter
          ...
          {!loading && totalPages > 1 && (
            <div className="px-8 py-6 border-t border-white/5 flex items-center justify-between bg-white/[0.01]">
              <p className="text-[10px] text-gray-500 font-black uppercase tracking-widest">
                Trang <span className="text-white">{query.page}</span> /{" "}
                <span className="text-white">{totalPages}</span> ({total} Kết
                quả)
              </p>

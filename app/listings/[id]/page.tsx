...
const STYLES = {
  ...
  backLink:
    "mb-6 flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors",
  // Skeleton
  ...
  errorLink:
    "mt-6 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors inline-block",
} as const;

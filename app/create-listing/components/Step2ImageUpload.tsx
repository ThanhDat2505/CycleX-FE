            ...
            >
                ...
                {isUploading ? (
                    <div className="flex flex-col items-center">
                        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#FF8A00] mb-2"></div>
            ...
            {imageUrls.length > 0 && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    {imageUrls.map((url, index) => (
                        <div
                            key={index}
                            className="relative group aspect-w-4 aspect-h-3 bg-gray-100 rounded-lg overflow-hidden border border-gray-200"
                        >
                            <img
                                src={url}

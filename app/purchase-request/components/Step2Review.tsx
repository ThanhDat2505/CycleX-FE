...
const STYLES = {
  ...
  header:
    "bg-gradient-to-br from-gray-900 via-gray-800 to-brand-primary/20 p-8 text-white relative overflow-hidden",
  ...
  sectionTitle:
    "text-xl font-extrabold text-gray-900 mb-5 flex items-center gap-3",
  transactionBox:
    "bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden",
  transactionTitle:
    "text-sm font-black uppercase tracking-widest text-gray-400 mb-5 pb-3 border-b border-gray-50 flex items-center gap-2",
  rowBetween: "flex justify-between items-center py-1.5",
  labelText: "text-gray-500 font-medium",
  valueText: "font-bold text-gray-900",
  typeBadge:
    "px-3 py-1 bg-orange-50 text-brand-primary rounded-full text-xs font-black shadow-sm border border-orange-100",
  noteBox: "mt-6 pt-5 border-t border-dashed border-gray-100",
  noteLabel:
    "flex items-center gap-2 text-gray-400 text-xs font-bold uppercase tracking-wider mb-2",
  noteValue:
    "text-gray-700 italic bg-gray-50/50 p-4 rounded-xl border border-gray-100/50 leading-relaxed text-sm",
  listingImage:
    "w-28 h-28 object-cover rounded-2xl border-2 border-white shadow-md flex-shrink-0 group-hover:scale-105 transition-transform",
  noImage:
    "w-28 h-28 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-400 border border-gray-100",
  listingTitle: "text-lg font-black text-gray-900 line-clamp-2 leading-snug",
  locationRow:
    "flex items-center gap-1.5 text-gray-400 text-xs font-bold mt-2 uppercase tracking-wide",
  priceText:
    "text-brand-primary font-black text-xl mt-3 flex items-baseline gap-1",
  sellerCard:
    "flex items-center gap-4 p-4 rounded-2xl border border-gray-100/50 bg-white shadow-sm hover:shadow-md transition-shadow",
  sellerAvatar:
    "w-12 h-12 rounded-xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center text-gray-800 font-black shadow-inner",
  receiverBox:
    "bg-white p-6 rounded-2xl border border-orange-50/50 shadow-sm relative overflow-hidden space-y-3 before:absolute before:left-0 before:top-0 before:w-1 before:h-full before:bg-brand-primary",
  feeBox:
  ...
  terms:
    "text-[11px] text-gray-400 mt-10 text-center max-w-lg mx-auto leading-relaxed border-t border-gray-100 pt-6 font-medium",
  termsLink:
    "text-brand-primary hover:text-brand-primary-hover font-bold decoration-dotted underline underline-offset-4",
  actions:
    "flex flex-col sm:flex-row justify-between gap-5 mt-10 pt-8 border-t border-gray-100/80",
  btnBack:
    "!w-full sm:!w-auto px-10 py-3.5 text-base font-bold text-gray-400 hover:text-gray-800 transition-colors",
  btnConfirm:
    "!w-full sm:!w-auto px-12 py-4 text-lg font-black bg-brand-primary hover:bg-brand-primary-hover text-white shadow-xl shadow-orange-100 hover:shadow-orange-200 hover:-translate-y-1 active:translate-y-0 transition-all rounded-2xl flex items-center justify-center gap-3",
} as const;
    ...
    <div className={STYLES.card}>
      ...
      <div className={STYLES.header}>
        <div className="relative z-10">
          <h2 className={STYLES.headerTitle}>
            <CheckCircle
              size={28}
              className="text-brand-primary animate-pulse-slow"
            />
            {MESSAGES.S50_STEP2_TITLE}
          </h2>
          <p className={STYLES.headerSubtitle}>{MESSAGES.S50_STEP2_SUBTITLE}</p>
        </div>
      ...
      <div className={STYLES.content}>
            ...
            <div className={STYLES.sellerCard}>
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 leading-none mb-1">
                  {MESSAGES.S50_REVIEW_SELLER_LABEL}
                </p>
                <p className="font-bold text-gray-900">
                  {listing.sellerName || MESSAGES.S50_REVIEW_SELLER_DEFAULT}
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className={STYLES.receiverBox}>
                <p className={STYLES.rowBetween}>
                  <span className={STYLES.labelText}>
                    {MESSAGES.S50_REVIEW_NAME_LABEL}
                  </span>
                  <span className={STYLES.valueText}>
                ...
                <p className={STYLES.rowBetween}>
                  <span className={STYLES.labelText}>
                    {MESSAGES.S50_REVIEW_PHONE_LABEL}
                  </span>
              ...
              <div className={STYLES.feeBox}>
                ...
                <div className={STYLES.feeTotal}>
                  <div className="flex flex-col items-end w-full gap-1">
                    <span className={STYLES.feeTotalLabel}>
                      {MESSAGES.S50_REVIEW_TOTAL}
                    </span>
        ...
        <p className={STYLES.terms}>
          {MESSAGES.S50_REVIEW_TERMS}{" "}
          <a href="#" className={STYLES.termsLink}>
            {MESSAGES.S50_REVIEW_TOS}
          </a>{" "}
          &{" "}
          <a href="#" className={STYLES.termsLink}>
            {MESSAGES.S50_REVIEW_PRIVACY}
          </a>
          .
          <br />
          <span className="opacity-80 mt-1 inline-block font-bold">
            {MESSAGES.S50_REVIEW_DEADLINE}
          </span>
        </p>

...
const STYLES = {
  ...
  bikeIcon:
    "w-8 h-8 rounded-lg bg-brand-primary/10 text-brand-primary flex items-center justify-center",
  stepContent: "mt-12",
  bgDecorative1:
    ...
    <div className={STYLES.pageWrapper}>
      ...
      <div className={STYLES.container}>
        ...
        <div className={STYLES.headerPart}>
          <h1 className={STYLES.pageTitle}>{MESSAGES.S50_PAGE_TITLE}</h1>
        ...
        {/* Step Content */}
        <div
          className={`${STYLES.stepContent} animate-slide-up [animation-delay:200ms]`}
        >
          {currentStep === 1 ? (
            <Step1InputForm
              formData={formData}

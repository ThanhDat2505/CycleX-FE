        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 animate-fade-in">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-8 border border-gray-100">
                    <div
                        className={`p-8 text-center ${isSolved
                                ? "bg-green-50"
                                : isRejected
                                    ? "bg-red-50"
                                    : "bg-orange-50"
                    ...
                    >
                        <div
                            className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-sm ${isSolved
                        ...
                        <h1
                            className={`text-3xl font-black tracking-tight mb-2 ${isSolved
                                    ? "text-green-900"
                                    : isRejected
                                        ? "text-red-900"
                                        : "text-orange-900"
                        ...
                        <p
                            className={`text-sm font-bold uppercase tracking-widest opacity-70 ${isSolved
                                    ? "text-green-700"
                                    : isRejected
                                        ? "text-red-700"
                                        : "text-orange-700"

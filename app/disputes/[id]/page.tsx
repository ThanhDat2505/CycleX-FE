        ...
        <div className="space-y-10">
          ...
          <div className="animate-fade-in">
            ...
            >
              ...
              {/* NEED MORE INFO: Block thông báo bổ sung thông tin đã bị ẩn ở đây. Muốn bật lại, bỏ comment dưới */}
              {false && (
          ...
          {/* NEED MORE INFO: Block phản hồi bổ sung đã bị ẩn ở đây. Muốn bật lại, bỏ comment dưới */}
          {false && (
            <div className="animate-fade-in">

...
export default function VehicleInfoCard({ transaction }: VehicleInfoCardProps) {
  ...
  return (
    <div
      className="bg-white rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up"
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="flex items-center gap-3">
              <span className="px-2.5 py-0.5 bg-gray-100 text-gray-600 rounded text-xs font-mono">
                ID: {transaction.listingId}
              </span>
              <span className="text-gray-300">|</span>
              <span className="text-sm text-gray-500">
                Người bán: Đã xác thực CycleX
              </span>
            </div>

...
import { canCreateDispute } from "@/app/services/buyerDisputeService";
  ...
  useEffect(() => {
    ...
    async function fetchDetail() {
      ...
      try {
        ...
        if (isMounted) {
          const isOwner =
            data.buyerId === user.userId || data.sellerId === user.userId;
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        const updated = await getTransactionDetail(

...
const CANCELLABLE_STATUSES: ReadonlySet<string> = new Set(["PENDING", "APPROVE"]);

export function MyListingCard({ listing, onDelete, isDeleting, onCancelPublish, isCancelling }: MyListingCardProps) {

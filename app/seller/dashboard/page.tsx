          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
              ...
              <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="space-y-4">
                  <div className="pb-4 border-b border-gray-50 last:border-0 border-l-4 border-l-orange-500 pl-4 bg-orange-50/30">
                    <p className="text-sm text-orange-600 mb-1 font-semibold">Action Required</p>
                    <Link href="/seller/listings/1/inspection-response" className="font-semibold text-gray-900 hover:text-orange-600 transition-colors block">
                      📋 Please respond to inspection requirements
                    </Link>
                    <p className="text-sm text-gray-600">Inspector requested more info for Trek Domane</p>
                  </div>

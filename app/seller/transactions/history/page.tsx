...
export default function TransactionHistoryPage() {
  ...
  const insights = useMemo(() => {
    ...
    const finishedTransactions =
      completedTransactions.length + cancelledTransactions.length;
    ...
    const completionRate =
      finishedTransactions > 0
        ? Math.round(
            (completedTransactions.length / finishedTransactions) * 100,
          )
        : 0;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-2">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 text-white shadow-lg shadow-blue-200">
              ...
              <p className="text-2xl font-bold">
                {formatPrice(insights.totalRevenue)}
              </p>
            </div>
            <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
              ...
              <div className="flex items-end gap-2">
                ...
                <span className="text-green-600 text-xs font-bold mb-1">
                  +{insights.thisMonthRevenue.toLocaleString()}đ
                </span>
              </div>
            </div>
            <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
            ...
            <div className="bg-white border-2 border-gray-100 rounded-xl p-4 shadow-sm flex flex-col justify-center items-center cursor-pointer hover:bg-gray-50 transition-colors border-dashed">
                    ...
                    {filteredTransactions.map((t) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          ...
                          <span
                            className={`text-[10px] px-1.5 py-0.5 rounded font-medium ${t.transactionType === TRANSACTION_TYPE.PURCHASE ? "bg-blue-50 text-blue-600" : "bg-orange-50 text-orange-600"}`}
                          >
                            {TRANSACTION_TYPE_LABELS[
                              t.transactionType as keyof typeof TRANSACTION_TYPE_LABELS
                            ] || t.transactionType}
